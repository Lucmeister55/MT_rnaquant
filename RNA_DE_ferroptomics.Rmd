...
```{r}
plot_pca <- function(dds, dir, affix) {
  rld <- vst(dds)

  jpeg(paste0(dir, "/PCA_", affix, ".jpeg"), width = 900, height = 900)
...
jpeg(paste0(dir, "/PCA_full.jpeg"), width = 900, height = 900)
pcaplot(rld_full, intgroup=c("Group"), ellipse = FALSE)
dev.off()

jpeg(paste0(dir, "/PCA_filt1.jpeg"), width = 900, height = 900)
pcaplot(rld_filt1, intgroup=c("Group"), ellipse = FALSE)
dev.off()

jpeg(paste0(dir, "/PCA_filt2.jpeg"), width = 900, height = 900)
pcaplot(rld_filt2, intgroup=c("Group"), ellipse = FALSE)
dev.off()

jpeg(paste0(dir, "/PCA_filt3.jpeg"), width = 900, height = 900)
...
```{r}
jpeg("rnaseq_ferroptomics/DifferentialAnalysis/MAplot_RvsS.jpeg", width = 1500, height = 1000)
