...
# Calculate set sizes and percentages
...
# Generate bar plot
generate_bar_plot <- function(set_data, ylabel, file) {
  # Exclude the "whitelist" bar
  set_data <- set_data[set_data$Set != "whitelist", ]
  
  ggplot(set_data, aes(x = Set)) +
    geom_bar(aes(y = Total_Size), stat = "identity", fill = "lightblue") +
    geom_bar(aes(y = FRG_Size), stat = "identity", fill = "red", alpha = 0.7) +
    ...
    ggtitle("Gene Set Whitelist Overlap") +
...
# Generate bar plots
generate_bar_plot(set_data_up, "Gene Set Sizes - Upregulated", "outputs/DifferentialAnalysis/bar_plot_up.png")
generate_bar_plot(set_data_down, "Gene Set Sizes - Downregulated", "outputs/DifferentialAnalysis/bar_plot_down.png")
