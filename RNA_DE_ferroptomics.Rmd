...
# Generate bar plot
generate_bar_plot <- function(set_data, gene_sets, title, ylabel, file) {
  ...
  set_data$Set <- factor(set_data$Set, levels = names(gene_sets))
...
# Generate bar plots
generate_bar_plot(set_data_up[sel, ], gene_sets_up[sel], "Differential Gene Set Overlap With Whitelist - Upregulated", "Gene Set Sizes - Upregulated", "outputs/DifferentialAnalysis/bar_plot_up.png")
generate_bar_plot(set_data_down[sel, ], gene_sets_down[sel], "Differential Gene Set Overlap With Whitelist - Downregulated", "Gene Set Sizes - Downregulated", "outputs/DifferentialAnalysis/bar_plot_down.png")
