...
countdata_newIMR <- read.delim("rnaseq_ferroptomics/outputs/count_matrix/countmatrix_IMR.csv")
countdata_fc_raw <- cbind(countdata_fc_raw, subset(countdata_newIMR, select = -c(gene_symbol, Ensembl_ID, length)))
